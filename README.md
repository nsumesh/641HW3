...
The results are logged to the results directory after which a comparative analysis can be conducted to see how each model performed on different statistics such as Accuracy, F1 Score and the perfomance of the best and worst model. Run the following command to do this.
```
